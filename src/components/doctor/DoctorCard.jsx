...
const DoctorCard = ({ item }) => {
  ...
  return (
    <div className='mySwiper w-full border-2 border-lightGray hover:border-mainPurple hover:shadow-md hover:shadow-mainPurple rounded-2xl p-4 lg:mb-8 flex flex-col gap-5 items-center justify-center transition-all duration-700 '>
